          ...
          <SidebarFooter className="border-t border-border p-4 bg-card">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="w-full justify-start px-3 py-7 h-auto rounded-2xl hover:bg-accent transition-colors"
                >
                  <div className="flex items-center gap-3 w-full">
                    ...
                    <div className="flex flex-col items-start flex-1 text-left overflow-hidden">
                      <span className="text-sm font-bold leading-none truncate w-full text-foreground">
                        {userEmail || "Account"}
                      </span>
              ...
              >
                ...
                <DropdownMenuItem
                  onClick={onLogout}
                  className="text-destructive font-bold hover:bg-destructive/10 focus:bg-destructive/10 focus:text-destructive cursor-pointer"
                >
