      ...
      <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="space-y-3">
              <input
                ...
                required
                className="w-full h-10 px-4 rounded-xl border bg-muted/50 text-sm focus:ring-2 focus:ring-primary/20 outline-none transition-all"
              />
              <input
                name="sub"
              ...
              <select
                name="tone"
                required
                className="w-full h-10 px-4 rounded-xl border bg-muted/50 text-sm focus:ring-2 focus:ring-primary/20 outline-none transition-all appearance-none cursor-pointer"
              >
          ...
          >
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <textarea
                ...
                required
                className="w-full h-full min-h-[100px] px-4 py-3 rounded-xl border bg-muted/50 text-sm focus:ring-2 focus:ring-primary/20 outline-none transition-all resize-none"
              ></textarea>
            </div>
            <button
              type="submit"
              className="w-auto px-8 h-10 rounded-xl bg-primary text-primary-foreground font-bold text-sm hover:opacity-90 transition-opacity"
            >
              Add FAQ
            </button>
          </form>
        ...
        <div className="rounded-3xl border border-primary/20 bg-primary/5 p-6 shadow-sm flex flex-col md:col-span-2">
          <h3 className="font-display text-lg font-bold mb-4 text-primary">
            Promote / Sponsor a Product
          </h3>
          <p className="text-sm text-muted-foreground mb-4">
            Featured products are highlighted on the Customer Homepage to increase vendor sales.
          </p>
          <form
            onSubmit={async (e) => {
              e.preventDefault();
          ...
          >
            <input
              ...
              required
              className="flex-1 w-full h-10 px-4 rounded-xl border bg-background text-sm focus:ring-2 focus:ring-primary/20 outline-none transition-all shadow-sm"
            />
            <select
              name="action"
              required
              className="w-full sm:w-auto h-10 px-4 rounded-xl border bg-background text-sm focus:ring-2 focus:ring-primary/20 outline-none transition-all shadow-sm cursor-pointer"
            >
            ...
            <button
              type="submit"
              className="w-full sm:w-auto h-10 px-6 rounded-xl bg-primary text-primary-foreground font-bold text-sm shadow-md hover:shadow-lg transition-all"
            >
              Apply Status
            </button>
          </form>
