        ...
        <div className="space-y-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Verify legal documents for{" "}
              <span className="text-foreground font-bold">{vendor.business_name}</span>
            </p>
          </div>
          ...
          {!kyc ? (
            <div className="rounded-3xl border border-dashed border-border p-12 text-center bg-muted/40">
              ...
              <p className="text-sm text-muted-foreground mt-2">
                This vendor has not submitted their identity verification yet.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="rounded-2xl border border-border p-5 bg-muted/40">
                  ...
                  <div className="font-black text-lg mt-1 uppercase text-foreground tracking-wide">
                    {kyc.document_number}
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-border p-5 bg-muted/40 flex justify-between items-center">
                <div>
                  ...
                  <div
                    className={`font-black text-lg uppercase mt-1 ${
                      kyc.status === "approved"
                        ? "text-emerald-600"
                        : kyc.status === "rejected"
                          ? "text-rose-600"
                ...
                <div className="flex gap-4">
                  ...
                  >
                    {isApproving ? (
                      ...
                      <>
                        <CheckCircle2 className="h-5 w-5" /> Approve Vendor
                      </>
                    )}
                  </button>
                </div>
