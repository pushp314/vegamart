...
export const ALLOWED_ORDER_TRANSITIONS: Record<string, ReadonlySet<string>> = {
  ...
  CONFIRMED: new Set(["CONFIRMED", "PREPARING", "PACKED", "READY_FOR_PICKUP", "PICKED_UP", "DELIVERED", "CANCELLED", "FAILED"]),
  PREPARING: new Set(["PREPARING", "PACKED", "READY_FOR_PICKUP", "PICKED_UP", "DELIVERED", "CANCELLED"]),
  PACKED: new Set(["PACKED", "READY_FOR_PICKUP", "PICKED_UP", "DELIVERED", "CANCELLED"]),
