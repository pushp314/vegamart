...
describe("admin vendor service", () => {
  ...
  it("returns vendor detail with stats", async () => {
    ...
    repo.getVendorStats.mockResolvedValue({
      ...
      item_revenue: new Prisma.Decimal(900),
      total_earnings: new Prisma.Decimal(855),
      gross_earnings: new Prisma.Decimal(855),
      refunded_earnings: new Prisma.Decimal(0),
      pending_earnings: new Prisma.Decimal(20),
      today_earnings: new Prisma.Decimal(100),
      weekly_earnings: new Prisma.Decimal(450),
      monthly_earnings: new Prisma.Decimal(800),
      product_count: 10,
