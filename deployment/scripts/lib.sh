...
load_config() {
  ...
  export APP_BASE_DIR RELEASES_DIR BACKUPS_DIR LOGS_DIR CONFIGS_DIR TMP_DIR CURRENT_LINK ENV_FILE DB_PASSWORD_FILE REDIS_PASSWORD_FILE API_PORT WEB_PORT DOMAIN PM2_BACKEND_INSTANCES
}
